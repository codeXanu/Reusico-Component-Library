  ...
  return(
    <>
      ...
      <div className="badge-container">
        ...
        <h2 className="heading1">Badges:--</h2>
        </div>
      ...
      <div className="banners-container">
        <div className="content-heading">
          <h2 className="heading1">Banners:-</h2>
        </div>
      ...
      <div className="cards-container">
        ...
        <h2 className="heading1">Cards:-</h2>
      ...
      <div className="testimonialWithImage-container">

        <h2 className="heading1">Testimonials with Image:-</h2>
      ...
      <div className="testimonialWithoutImage-container">

        <h2 className="heading1" >Testimonials without Image:-</h2>
      ...
      <div className="all-tooltip-container">
      ...
      <div className="all-toast-container">
      ...
      <footer className="footer">
            <p>Made with ❤️ by codeXanuj | © 2025</p>
      </footer>
    </>
  )
}
